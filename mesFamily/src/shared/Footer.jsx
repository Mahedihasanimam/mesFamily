    ...
    <div className="container p-6 mx-auto">
        <div className="lg:flex">
            <div className="w-full -mx-6 lg:w-2/5">
                <div className="px-6">
                    <a href="#">
                    <Link to={'/'} className=" font-bold lg:text-2xl text-xl"><span className="text-[#3B82F6]">MesFamily</span></Link>
                    </a>
                ...
                <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                    <div >
                       ...
                       <div className="text-gray-500">
                        ...
                        <Link to={'/membar'}  className="block mt-2 text-sm dark:text-gray-400 hover:underline">Members</Link>
        ...
        <div>
            <p className="text-center text-gray-500 dark:text-gray-400">© <span className=" font-bold  text-sm"><span className="text-[#3B82F6]">Mes Family</span></span> 2024 - All rights reserved by Mehedi</p>
        </div>
    </div>
</footer>
    );
