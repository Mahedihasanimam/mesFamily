...
const Navbar = () => {
 const {user,logout}=useContext(AuthContext)
  ...
  return (
    <div className=" bg-base-100 bg-opacity-70 absolute z-50 w-full   shadow-md ">
      <div className="navbar flex container px-4 mx-auto">
        ...
        <div className="navbar-end">
          <label className="swap swap-rotate lg:mr-6 mr-2">
  ...
  <div className="w-10 rounded-full ring ring-primary ring-offset-base-100 ring-offset-2">
    <img src={user?.photoURL} />
          ...
          {
            user?<button onClick={handlelogout} className="btn bg-[#3B82F6] lg:px-8 text-white font-bold rounded-md text-lg">
            Logout
          </button>:
